...
const CreateForm: FC = () => {
  ...
  return (
    isStepOne ?
      ...
      <button className={"base-btn"} onClick={()=>{setIsStepOne(!isStepOne)}}>Далее</button>
    </div>
      ):
      (
        <div className={"main-container flex flex-col gap-8"}>
          ...
          <div>
            ...
            <div className={"flex justify-between mt-3 text-[14px] leading-5"}>
              ...
              <button className={"text-danger"}><img src={dump} alt="" className={"inline mr-1.5 pb-0.5"} /> Удалить поле</button>
            </div>
          </div>
